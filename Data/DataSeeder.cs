    ...
    public void ApplySeeding()
    {
        ...
        var characters = new List<Character>()
        {
            ...
            new()
            {
                ...
                LongDescription = "Ah, let me regale you with the tale of Leonardo \"Naija\" da Vinci, the Renaissance man who took Lagos by storm and turned the art world upside down faster than you can say \"jollof rice.\"\r\nBorn in the bustling metropolis of Lagos, young Leo quickly established himself as the local prodigy with a knack for sketching okada riders mid-wheelie and designing futuristic variations of agbada. His parents, proud owners of the neighborhood's most poppin' bukka joint, encouraged his creative pursuits, even when he insisted on painting with palm oil instead of acrylics.\r\nAs a young omo, Leonardo's insatiable curiosity led him to study everything from the aerodynamics of flying suya to the structural integrity of indomie noodle towers. He famously painted the \"Mona Lekki,\" a masterpiece featuring a mysterious woman with an enigmatic smile, holding a plate of pounded yam and wearing a gele that defied the laws of physics. Art critics are still debating whether her expression is one of contentment or if she's just thinking about the Lagos traffic she'll face on her way home.\r\nLeonardo's inventions were as Nigerian as they were revolutionary. He sketched designs for a generator that ran on the pure vibes of Fela Kuti's music and a time machine powered by the collective impatience of people waiting in ATM queues. His magnum opus was a solar-powered air conditioner that could also charge phones and dispense cold zobo, but sadly, it remained unfinished as he kept getting distracted by impromptu dance-offs at owambe parties.\r\nDespite his genius, Leo remained a true Naija boy at heart. He could often be found at Lekki market, using his mathematical skills to haggle prices down to the last kobo or creating detailed blueprints for the perfect jollof rice recipe. Legend has it that he once won a bet by successfully predicting the exact minute NEPA would take light, using only a palm frond and the position of the sun.\r\nToday, Leonardo \"Naija\" da Vinci is remembered as Nigeria's greatest polymath, a man who could paint the ceiling of Aso Rock while balancing a tray of chin-chin on his head, and who proved that even in the 15th century, Nigerian ingenuity was already streets ahead. Oya now!",
            ...
            new()
            {
                ...
                OriginCountry = countries.Single(c => c.Name == "Australia"),
                PortraitUrl = "https://i.ytimg.com/vi/Ux5cQbO_ybw/maxresdefault.jpg",
                Power = 1
            },
        };
